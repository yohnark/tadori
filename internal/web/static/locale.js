  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      ...
      policy: {
        ...
        directCertificateIssuer: "Direct certificate issuer",
        proxyCertificateIssuer: "Proxy certificate issuer",
        issuersDiffer: "TLS issuers differ",
    ...
    ja: Object.freeze({
      ...
      policy: { eyebrow: "プロキシ / ポリシー", title: "エンタープライズ経路の観測", runtime: "設定と実行時の証拠", requestedIdentity: "要求された識別情報", state: "状態", unsupported: "未サポート", proxyDiverges: "プロキシ設定の差異", divergenceKnown: "差異の判明", directVsProxy: "直接接続とプロキシ", firewall: "ファイアウォール", tlsPolicy: "TLS ポリシー状態", directCertificateIssuer: "直接接続の証明書発行者", proxyCertificateIssuer: "プロキシの証明書発行者", issuersDiffer: "TLS 発行者の差異", possibleInterception: "傍受の可能性", interceptionSuspicion: "傍受の疑い", certainty: "確度", provenance: "プロヴェナンス", evidence: "証拠", paths: "直接、ブラウザ、サービスの経路", path: "経路", mode: "モード", endpoint: "エンドポイント", tcp: "TCP", http: "HTTP", tls: "TLS", profile: "プロファイル", enabled: "有効", policyPresent: "ポリシーの存在", causality: "因果関係", source: "ソース", configuration: "設定", configuredEndpoints: "設定済みプロキシエンドポイント", pacConfigured: "PAC 設定済み", effectiveMode: "実効モード", effectiveEndpoint: "実効エンドポイント", effectiveResolution: "実効解決", pacUsed: "PAC 使用済み", winHTTP: "WinHTTP", winINET: "WinINET", firewallProfiles: "ファイアウォールプロファイル" },
